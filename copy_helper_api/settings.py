...
from copy_helper_api import tools
...
class GeneralSettings:
    ...
    def set_settings(cls):
        ...
        settings_dict = {
            ...
            "DirectoryToStoreResults": "C:\\Users\\nikit\\OneDrive\\Documents\\pyfile\\DomainsResults\\",
            "ResultDirectoryType": "Date-Domain",
            "AutoImagesSavePath": "C:\\Users\\nikit\\OneDrive\\Documents\\pyfile\\DomainsResults\\images\\",
            "InformationLevel": "All",
            "DomainsShortNames": {
                "WFR": "WorldFinReport.com",
                "UC": "UrbanCapitalist.com"
            },
            "DefaultStyles": {
                "FontSize": "21px",
                "FontFamily": "Tahoma",
